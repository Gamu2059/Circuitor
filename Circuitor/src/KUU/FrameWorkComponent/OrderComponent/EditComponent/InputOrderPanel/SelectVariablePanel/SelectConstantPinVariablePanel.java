...
import KUU.FrameWorkComponent.OrderComponent.EditComponent.InputOrderPanel.SelectVariablePanel.VariableComponent.*;
...
/**
 * 定数,ピン,変数,一次元配列,二次元配列から使用する変数を選択するパネルを生成するクラス
 */
public class SelectConstantPinVariablePanel extends NewJPanel implements MouseListener{
    ...
    public SelectConstantPinVariablePanel(BaseFrame frame) {
        super(frame);
        setLayout(null);
